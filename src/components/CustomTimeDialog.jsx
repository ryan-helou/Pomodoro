...
const CustomTimeDialog = ({ onSetCustom, onClose, backgroundColors }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className={`rounded-2xl p-6 md:p-8 w-full space-y-4 md:space-y-6 ${isMobile ? 'max-w-full' : 'max-w-sm'}`} style={gradientStyle}>
        {/* Header */}
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            <button
              ...
              className="btn-secondary bg-white/20 text-white hover:bg-white/30 active:bg-white/40 text-lg md:text-xl w-14 md:w-12 h-14 md:h-12 flex items-center justify-center p-0 backdrop-blur"
            >
              −
            </button>
            <input
              ...
              className="flex-1 bg-white/10 text-white text-center rounded-lg py-3 md:py-2 px-4 font-semibold text-base md:text-lg placeholder-white/50 backdrop-blur"
            />
            <button
